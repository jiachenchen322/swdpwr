...
%let mydir=C:\Users\xifan\Desktop\; /*modify this to the directory to the downloaded exe file swdpwr*/

%let outfile=.\out.txt ;

%let myprog=&mydir.swdpwr.exe;
...
/*need to modify line %let mydir=C:\Users\xifan\; with proper directory to swdpwr on your own computer*/
